<template>
  <div>
    <section class="wrapper !bg-[#ffffff]">
      ...
      >
        <div
          class="flex flex-wrap mx-[-15px] xl:mx-[-35px] lg:mx-[-20px] mt-[-30px] items-center"
        >
          <div
            class="xl:w-7/12 lg:w-7/12 w-full flex-[0_0_auto] px-[15px] max-w-full xl:!order-2 lg:!order-2 xl:px-[35px] lg:px-[20px] mt-[30px]"
          >
          ...
          <div
            class="xl:w-5/12 lg:w-5/12 w-full flex-[0_0_auto] px-[15px] max-w-full mt-12 xl:px-[35px] lg:px-[20px] mt-[30px]"
          >
            <div
              class="swiper-container dots-closer !mb-6 relative z-10"
              data-margin="30"
              data-dots="true"
            >
              <div class="swiper">
